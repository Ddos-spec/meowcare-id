...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex h-full w-64 shrink-0 -translate-x-full flex-col border-r border-brand-100 bg-white px-4 py-5 transition-transform duration-200 lg:static lg:translate-x-0 ${
          open ? "translate-x-0" : ""
        }`}
      >
